1. Создать ssh ключ можно командой	`ssh-keygen -t rsa`	,при использовании этой команды создается пара ключей: приватный и публичный, публичный передается GitHub.*
